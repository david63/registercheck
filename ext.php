...
namespace david63\registercheck;
	...
	*/
	public function is_enableable()
	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/registercheck');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/registercheck', 'ext_enable_error');
			}
		}
